...
function PredictStroke() {
  ...
  const beginQuery = () =>{
    ...
    if(checkInputValid()){
      ...
      setMLStrokeResult('Invalid or Missing Inputs, Please check again')
    }
  };
  ...
  const columns = useMemo(
      () => [
        {
          // first group - Weight Statistics (Percentage) Data
          Header: "Weight Statistics (Percentage)",
          // First group columns
          columns: [
            {
              Header: "Gender",
              accessor: "matched_gender_percent"
            },
            {
              Header: "Hypertension",
              accessor: "matched_hyper_percent"
            },
            {
              Header: "Heart Disease",
              accessor: "matched_heart_percent"
            },
            {
              Header: "Ever Married",
              accessor: "matched_married_percent"
            },
            {
              Header: "Work Type",
              accessor: "matched_work_percent"
            },
            {
              Header: "Residence Type",
              accessor: "matched_residence_percent"
            },
            {
              Header: "Smoking Status",
              accessor: "matched_smoking_percent"
            }
          ]
        }
      ],
  ...
  return (
    <div className="App">
      <div className='form'>
        ...
        <div className="statsResultTable">
            <Table columns={columns} data={statsResult} />
        </div>
      </div>
